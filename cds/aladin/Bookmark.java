...
public class Bookmark extends JButton {
   ...
   Bookmark(Aladin aladin,String name,String descr,String code) {
      super();
      this.aladin = aladin;
   ...
   Bookmark(Aladin aladin, Function fonction) {
      super();
      this.aladin = aladin;
      this.fct = fonction;
      suite();
   ...
   protected Function getFunction() { return fct; }
...
//   }
   ...
   static final Color Orange = new Color(255,175,0);
