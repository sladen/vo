...
public final class PlanContour extends PlanTool {
   ...
   */
  protected PlanContour(Aladin aladin, String label, double[] levels, ContourAlgorithm cAlgo, boolean useSmoothing, int smoothingLevel, boolean useOnlyCurrentZoom, boolean reduceNoise, Color[] couleurs, Color cPlanContour) {
      this(aladin, label);
