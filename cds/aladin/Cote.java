...
public final class Cote extends Ligne {
   ...
   */
   ...
   static private Coord c1 = new Coord();
   static private Coord c2 = new Coord();
   ...
   protected void setId() {
      ...
      c1.x=v.HItoI(p1.xv[v.n]); v.HItoI(c1.y=p1.yv[v.n]);
      c2.x=v.HItoI(p2.xv[v.n]); v.HItoI(c2.y=p2.yv[v.n]);
   ...
   */
   ...
   protected boolean cutOn1() {
      ...
      if( x1!=x2 || y1!=y2 ) { 
         ...
         int mode = pi.type==Plan.IMAGERGB ? ZoomView.CUTRGB : ZoomView.CUTNORMAL;
