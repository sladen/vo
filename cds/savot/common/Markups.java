...
/**
* <p>VOTable markups and attributes </p>
...
// markups
final static String SAVOTPARSER = "2.5.2";
...
final  static String UTYPE = "utype"; /* new since VOTAble 1.1 */
...
final  static String NROWS = "nrows"; /* new since VOTAble 1.1 */
